#NoEnv
SendMode Input
SetWorkingDir, %A_MyDocuments%\GTA San Andreas User Files\Doctor Assistant
#NoTrayIcon
#Persistent
...
; РћР±РЅРѕРІР»РµРЅРёРµ РѕС‚ 04.08.2018
; Р”РѕРїРѕР»РЅСЏР»: MurKotik
; Р”РѕРїРѕР»РЅСЏР»: McFree
; Р”РѕРїРѕР»РЅСЏР»: aknqkzxlcs
; Р”РѕРїРѕР»РЅСЏР»: Godarck
; Р”РѕРїРѕР»РЅСЏР»: РЎР»СЋРЅСЏРІС‡РёРє
; Р”РѕРїРѕР»РЅСЏР»: MrGPro
; Р”РѕРїРѕР»РЅСЏР»: Phoenixxx_Czar
; Р”РѕРїРѕР»РЅСЏР»: Dworkin
; Р”РѕРїРѕР»РЅСЏР»: Ghost29
; Р”РѕРїРѕР»РЅСЏР»: slavawar
; Р”РѕРїРѕР»РЅСЏР»: Artur_iOS
; Р”РѕРїРѕР»РЅСЏР»: ByNika
; РџРµСЂРµРІС‘Р»: I_Qwerty_I
; Do not remove these lines.
; РќРµ СѓРґР°Р»СЏР№С‚Рµ РїРѕР¶Р°Р»СѓР№СЃС‚Р° Р°РІС‚РѕСЂРѕРІ
; ####################
; http://rebres.ru/SAMP-UDF-Developer.ahk
; DLL API Р±РёР±Р»РёРѕС‚РµРєР°: http://rebres.ru/AutoHotKey/Include SA-MP API AutoHotKey.rar
; Samp Dop Function: http://rebres.ru/AutoHotKey/SAMP-Dop-Function.ahk
; Р‘РёР±Р»РёРѕС‚РµРєР° dx9_overlay: http://rebres.ru/AutoHotKey/dx9_overlay for AHK.rar
...
; ######################### РЎС‚СЂСѓРєС‚СѓСЂС‹ РґРёР°Р»РѕРіР° #########################
...
global iUpdateTick                          := 2500 ; Р’СЂРµРјСЏ РІ РјСЃ, РёСЃРїРѕР»СЊР·СѓРµРјРѕРµ РІ С„СѓРЅРєС†РёСЏС… getPlayerNameById Рё РґСЂ. РґР»СЏ РѕР±РЅРѕРІР»РµРЅРёСЏ РґР°РЅРЅС‹С…. РџРѕ СѓРјРѕР»С‡Р°РЅРёСЋ 2500 (2.5 СЃРµРє)
; ###############################################################################################################################
; # 														                                                                    #
; # Р¤СѓРЅРєС†РёРё РґР»СЏ РІР·Р°РёРјРѕРґРµР№СЃС‚РІРёСЏ СЃ РєР»РёРµРЅС‚РѕРј SAMP                                                                                  #
; #     - IsSAMPAvailable()                         - Р’РѕР·РІСЂР°С‰Р°РµС‚ СЃРѕСЃС‚РѕСЏРЅРёРµ SAMP (0 - Р—Р°РїСѓС‰РµРЅ, 1 - Р’С‹РєР»СЋС‡РµРЅ)                     #
; #     - isInChat()                                - РџСЂРѕРІРµСЂСЏРµС‚ РѕС‚РєСЂС‹С‚ Р»Рё С‡Р°С‚ (0 - РЅРµС‚, 1 - РґР°)                                 #
; #     - getUsername()                             - Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅРёРє Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°                                          #
; #     - getId()                                   - Р’РѕР·РІСЂР°С‰Р°РµС‚ id Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°                                           #
; #     - SendChat(wText)                           - РћС‚РїСЂР°РІРєР° СЃРѕРѕР±С‰РµРЅРёСЏ/РєРѕРјР°РЅРґС‹ СЃРµСЂРІРµСЂСѓ                                        #
; #     - addChatMessage(wText)                     - Р›РѕРєР°Р»СЊРЅРѕРµ СЃРѕРѕР±РґРµС‰РёРµ РІ С‡Р°С‚                                                 #
; #     - showGameText(wText, dwTime, dwTextsize)   - РћС‚РѕР±СЂРѕР¶РµРЅРёРµ Game Text                                                     #
; #     - playAudioStream(wUrl)                     - Р’РѕСЃРїСЂРѕРёР·РІРµРґРµРЅРёРµ Р°СѓРґРёРѕРїРѕС‚РѕРєР°                                               #
; #     - stopAudioStream()                         - РћСЃС‚Р°РЅРѕРІРєР° Р°СѓРґРёРѕРїРѕС‚РѕРєР°                                                     #
; #	    - GetChatLine(Line, Output)		            - Р’С‹РІРѕРґ СЃС‚СЂРѕРєРё РёР· С‡Р°С‚ Р»РѕРіР° (0 - РџРѕСЃР»РµРґРЅСЏСЏ СЃС‚СЂРѕРєР°)                           #
; # 	- blockChatInput() 					        - Р‘Р»РѕРєРёСЂРѕРІРєР° РѕС‚РїСЂР°РІР»РµРЅРёСЏ СЃРѕРѕР±С‰РµРЅРёР№ СЃРµСЂРІРµСЂСѓ                                  #
; # 	- unBlockChatInput() 						- Р Р°Р·Р±Р»РѕРєРёСЂРѕРІРєР° РѕС‚РїСЂР°РІР»РµРЅРёР№ СЃРѕРѕР±С‰РµРЅРёР№ СЃРµСЂРІРµСЂСѓ                               #
; # 														                                                                    #
; # --------------------------------------------------------------------------------------------------------------------------- #
; # 														                                                                    #
; #     - getServerName()                           - Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅР°Р·РІР°РЅРёРµ СЃРµСЂРІРµСЂР°                       						#
; #     - getServerIP()                             - Р’РѕР·РІСЂР°С‰Р°РµС‚ IP СЃРµСЂРІРµСЂР°      						    			        #
; #     - getServerPort()                           - Р’РѕР·РІСЂР°С‰Р°РµС‚ РїРѕСЂС‚ СЃРµСЂРІРµСЂР°              									    #
; #     - CountOnlinePlayers()                      - Р’РѕР·РІСЂР°С‰Р°РµС‚ С‚РµРєСѓС‰РёР№ РѕРЅР»Р°Р№РЅ РЅР° СЃРµСЂРІРµСЂРµ                                      #
; # 														                                                                    #
; # --------------------------------------------------------------------------------------------------------------------------- #
; # 														                                                                    #
; #	    - getWeatherID()			                - Р’РѕР·РІСЂР°С‰Р°РµС‚ ID С‚РµРєСѓС‰РµР№ РїРѕРіРѕРґС‹                                              #
; #	    - getWeatherName()			                - Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅР°Р·РІР°РЅРёРµ С‚РµРєСѓС‰РµР№ РїРѕРіРѕРґС‹                                        #
; # 														                                                                    #
; # --------------------------------------------------------------------------------------------------------------------------- #
; # 														                                                                    #
; #     - patchRadio()                              - Р’РєР»СЋС‡Р°РµС‚ РїР°С‚С‡ РґР»СЏ Р°СѓРґРёРѕРїРѕС‚РѕРєР°                                             #
; #     - unPatchRadio()                            - Р’С‹РєР»СЋС‡Р°РµС‚ РїР°С‚С‡ РґР»СЏ Р°СѓРґРёРѕРїРѕС‚РѕРєР° 		                                    #
; # 														                                                                    #
; ###############################################################################################################################
; # Р¤СѓРЅРєС†РёРё РґР»СЏ РІР·Р°РёРјРѕРґРµР№СЃС‚РІРёСЏ СЃ РґРёР°Р»РѕРіР°РјРё (v.0.3.7)	        											                    #
; # --------------------------------------------------------------------------------------------------------------------------- #
; #	    - isDialogOpen()                            - РџСЂРѕРІРµСЂСЏРµС‚ РѕС‚РєСЂС‹С‚ Р»Рё РґРёР°Р»РѕРі                       	                       	#
; #	    - getDialogStyle()                          - Р’РѕР·РІСЂР°С‰Р°РµС‚ id СЃС‚РёР»СЏ РґРёР°Р»РѕРіР°                              					#
; #	    - getDialogID()                             - Р’РѕР·РІСЂР°С‰Р°РµС‚ id РґРёР°Р»РѕРіР° (РёСЃС…РѕРґСЏ РёР· РґР°РЅРЅС‹С… СЃРµСЂРІРµСЂР°)                  		#
; #	    - setDialogID(id)                           - РР·РјРµРЅРµРЅРёРµ ID РґРёР°Р»РѕРіР°          				                        	#
; #	    - getDialogCaption()                        - Р’РѕР·РІСЂР°С‰Р°РµС‚ Р·Р°РіРѕР»РѕРІРѕРє РґРёР°Р»РѕРіР°           			                        #
; #	    - getDialogText()                           - Р’РѕР·РІСЂР°С‰Р°РµС‚ С‚РµРєСЃС‚ РґРёР°Р»РѕРіР°                                                  #
; #	    - getDialogLineCount()                      - Р’РѕР·РІСЂР°С‰Р°РµС‚ РєРѕР»РёС‡РµСЃС‚РІРѕ СЃС‚СЂРѕРє РґРёР°Р»РѕРіР°                                       #
; #	    - getDialogLine(index)                      - Р’РѕР·РІСЂР°С‰Р°РµС‚ СЃРѕРґРµСЂР¶РёРјРѕРµ СЃС‚СЂРѕРєРё РїРѕ РЅРѕРјРµСЂСѓ           	                       	#
; #	    - getDialogLines()                          - Р’РѕР·РІСЂР°С‰Р°РµС‚ РјР°СЃСЃРёРІ СЃС‚СЂРѕРє РґРёР°Р»РѕРіР°  	     	        	                   	#
; #     - getDialogStructPtr()                      - Р’РѕР·РІСЂР°С‰Р°РµС‚ СѓРєР°Р·Р°С‚РµР»СЊ РЅР° СЃС‚СЂСѓРєС‚СѓСЂСѓ РґРёР°Р»РѕРіР°                                	#
; #	    - showDialog(style, caption, text, button1, button2, id) - РЎРѕР·РґР°РЅРёРµ Р»РѕРєР°Р»СЊРЅРѕРіРѕ РґРёР°Р»РѕРіР°         	                       	#
; ###############################################################################################################################
; # 														                                                                    #
; # Р¤СѓРЅРєС†РёРё РґР»СЏ РІР·Р°РёРјРѕРґРµР№СЃС‚РІРёСЏ СЃ РёРіСЂРѕРєР°РјРё                                                                                       #
; #	    - getTargetPed(dwPED)   			        - Р’РѕР·РІСЂР°С‰Р°РµС‚ PED ID, РїРѕ С‚Р°СЂРіРµС‚Сѓ                                             #
; #     - getPedById(dwId)                          - Р’РѕР·РІСЂР°С‰Р°РµС‚ PED ID РїРѕ id РёРіСЂРѕРєР°                                            #
; #     - getIdByPed(dwId)                          - Р’РѕР·РІСЂР°С‰Р°РµС‚ id РёРіСЂРѕРєР° РїРѕ PED                                               #
; #     - getStreamedInPlayersInfo()                - Р’РѕР·РІСЂР°С‰Р°РµС‚ РѕР±СЉРµРєС‚, С…СЂР°РЅСЏС‰РёР№ РёРЅС„РѕСЂРјР°С†РёСЋ РѕР± РёРіСЂРѕРєР°С… РІ Р·РѕРЅРµ СЃС‚СЂРёРјР°           #
; #     - callFuncForAllStreamedInPlayers(cfunc)    - Р’С‹Р·С‹РІР°РµС‚ С„СѓРЅРєС†РёСЋ РѕС‚РѕР±СЂР°Р¶Р°СЋС‰СѓСЋ РІСЃСЋ РёРЅС„РѕСЂРјР°С†РёРё Рѕ РёРіСЂРѕРєР°С… РІ Р·РѕРЅРµ СЃС‚СЂРёРјР°      #
; #	    - getDist(pos1, pos2)   			        - Р’РѕР·РІСЂР°С‰Р°РµС‚ СЂР°СЃС‚РѕСЏРЅРёРµ РјРµР¶РґСѓ РґРІСѓРјСЏ С‚РѕС‡РєР°РјРё                                  #
; #     - getClosestPlayerPed()                     - Р’РѕР·РІСЂР°С‰Р°РµС‚ PED ID Р±Р»РёР¶Р°Р№С€РµРіРѕ РёРіСЂРѕРєР°                                       #
; #     - getClosestPlayerId()                      - Р’РѕР·РІСЂР°С‰Р°РµС‚ id Р±Р»РёР¶Р°Р№С€РµРіРѕ РёРіСЂРѕРєР°                                           #
; #	    - getPedCoordinates(dwPED)   			    - Р’РѕР·РІСЂР°С‰Р°РµС‚ РєРѕСЂРґРёРЅР°С‚С‹ (РІ Р·РѕРЅРµ СЃС‚СЂРёРјР°) РїРѕ PED ID                            #
; #     - getTargetPosById(dwId)                    - Р’РѕР·РІСЂР°С‰Р°РµС‚ РїРѕР·РёС†РёСЋ РёРіСЂРѕРєР° РїРѕ id                                           #
; #     - getTargetPlayerSkinIdByPed(dwPED)         - Р’РѕР·РІСЂР°С‰Р°РµС‚ id СЃРєРёРЅР° РїРѕ PED ID                                             #
; #     - getTargetPlayerSkinIdById(dwId)           - Р’РѕР·РІСЂР°С‰Р°РµС‚ id СЃРєРёРЅР° РїРѕ id РёРіСЂРѕРєР°                                          #
; #     - calcScreenCoors(fX,fY,fZ)                 - Р’РѕР·РІСЂР°С‰Р°РµС‚ РјР°СЃСЃРёРІ РєРѕРѕСЂРґРёРЅР°С‚ [fX,fY,fZ] РѕС‚РЅРѕСЃРёС‚РµР»СЊРЅРѕ СЌРєСЂР°РЅР°                #
; # 														                                                                    #
; # Р¤СѓРЅРєС†РёРё РґР»СЏ РІР·Р°РёРјРѕРґРµР№СЃС‚РІРёСЏ СЃ С‚СЂР°РЅСЃРїРѕСЂС‚РѕРј:                                                                                   #
; #	    - getVehiclePointerByPed(dwPED)   			- Р’РѕР·РІСЂР°С‰Р°РµС‚ СѓРєР°Р·Р°С‚РµР»СЊ РЅР° С‚СЂР°РЅСЃРїРѕСЂС‚ РїРѕ PED ID                               #
; #	    - getVehiclePointerById(dwId)   			- Р’РѕР·РІСЂР°С‰Р°РµС‚ СѓРєР°Р·Р°С‚РµР»СЊ РЅР° С‚СЂР°РЅСЃРїРѕСЂС‚ РїРѕ id РёРіСЂРѕРєР°                            #
; #     - isTargetInAnyVehicleByPed(dwPED)          - РџСЂРѕРІРµСЂСЏРµС‚ РЅР°С…РѕРґРёС‚СЃСЏ Р»Рё РёРіСЂРѕРє РІ С‚СЂР°РЅСЃРїРѕСЂС‚Рµ РїРѕ PED ID                       #
; #     - isTargetInAnyVehicleById(dwId)            - РџСЂРѕРІРµСЂСЏРµС‚ РЅР°С…РѕРґРёС‚СЃСЏ Р»Рё РёРіСЂРѕРє РІ С‚СЂР°РЅСЃРїРѕСЂС‚Рµ РїРѕ id РёРіСЂРѕРєР°                    #
; #     - getTargetVehicleHealthByPed(dwPED)        - Р’РѕР·РІСЂР°С‰Р°РµС‚ hp С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ PED ID                                        #
; #     - getTargetVehicleHealthById(dwId)          - Р’РѕР·РІСЂР°С‰Р°РµС‚ hp С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ id РёРіСЂРѕРєР°                                     #
; #     - getTargetVehicleTypeByPed(dwPED)          - Р’РѕР·РІСЂР°С‰Р°РµС‚ С‚РёРї С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ PED ID (РІРѕР·РІСЂР°С‰Р°РµС‚ С‡РёСЃР»Рѕ, Р° РЅРµ РЅР°Р·РІР°РЅРёРµ)     #
; #     - getTargetVehicleTypeById(dwId)            - Р’РѕР·РІСЂР°С‰Р°РµС‚ С‚РёРї С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ id РёРіСЂРѕРєР° (РІРѕР·РІСЂР°С‰Р°РµС‚ С‡РёСЃР»Рѕ, Р° РЅРµ РЅР°Р·РІР°РЅРёРµ)  #
; #     - getTargetVehicleModelIdByPed(dwPED)       - Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅРѕРјРµСЂ РјРѕРґРµР»Рё С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ PED ID                              #
; #     - getTargetVehicleModelIdById(dwId)         - Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅРѕРјРµСЂ РјРѕРґРµР»Рё С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ id РёРіСЂРѕРєР°                           #
; #     - getTargetVehicleModelNameByPed(dwPED)     - Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅР°Р·РІР°РЅРёРµ РјРѕРґРµР»Рё С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ PED ID 				            #
; #     - getTargetVehicleModelNameById(dwId)       - Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅР°Р·РІР°РЅРёРµ РјРѕРґРµР»Рё С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ id РёРіСЂРѕРєР° 				        #
; #     - getTargetVehicleLightStateByPed(dwPED)    - Р’РѕР·РІСЂР°С‰Р°РµС‚ СЃРѕСЃС‚РѕСЏРЅРёРµ СЃРІРµС‚Р° С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ PED ID (РІРєР»./РІС‹РєР».)			    #
; #     - getTargetVehicleLightStateById(dwId)      - Р’РѕР·РІСЂР°С‰Р°РµС‚ СЃРѕСЃС‚РѕСЏРЅРёРµ СЃРІРµС‚Р° С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ id РёРіСЂРѕРєР° (РІРєР»./РІС‹РєР».)		    #
; #     - getTargetVehicleEngineStateByPed(dwPED)   - Р’РѕР·РІСЂР°С‰Р°РµС‚ СЃРѕСЃС‚РѕСЏРЅРёРµ РјРѕС‚РѕСЂР° С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ PED ID (РІРєР»./РІС‹РєР».)			    #
; #     - getTargetVehicleEngineStateById(dwId)     - Р’РѕР·РІСЂР°С‰Р°РµС‚ СЃРѕСЃС‚РѕСЏРЅРёРµ РјРѕС‚РѕСЂР° С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ id РёРіСЂРѕРєР° (РІРєР»./РІС‹РєР».) 			#
; #     - getTargetVehicleLockStateByPed(dwPED)     - Р’РѕР·РІСЂР°С‰Р°РµС‚ СЃРѕСЃС‚РѕСЏРЅРёРµ РґРІРµСЂРµР№ С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ PED ID (Р·Р°РєСЂС‹С‚С‹/РѕС‚РєСЂС‹С‚С‹) 	    #
; #     - getTargetVehicleLockStateById(dwId)       - Р’РѕР·РІСЂР°С‰Р°РµС‚ СЃРѕСЃС‚РѕСЏРЅРёРµ РґРІРµСЂРµР№ С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ id РёРіСЂРѕРєР° (Р·Р°РєСЂС‹С‚С‹/РѕС‚РєСЂС‹С‚С‹)     #
; #     - getTargetVehicleColor1ByPed(dwPED)        - Р’РѕР·РІСЂР°С‰Р°РµС‚ 1-Р№ С†РІРµС‚ С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ PED ID 			                        #
; #     - getTargetVehicleColor1ById(dwId)          - Р’РѕР·РІСЂР°С‰Р°РµС‚ 1-Р№ С†РІРµС‚ С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ id РёРіСЂРѕРєР°			                    #
; #     - getTargetVehicleColor2ByPed(dwPED)        - Р’РѕР·РІСЂР°С‰Р°РµС‚ 2-Р№ С†РІРµС‚ С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ PED ID 			                        #
; #     - getTargetVehicleColor2ById(dwId)          - Р’РѕР·РІСЂР°С‰Р°РµС‚ 2-Р№ С†РІРµС‚ С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ id РёРіСЂРѕРєР° 			                    #
; #     - getTargetVehicleSpeedByPed(dwPED)         - Р’РѕР·РІСЂР°С‰Р°РµС‚ С‚РµРєСѓС‰СѓСЋ СЃРєРѕСЂРѕСЃС‚СЊ С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ PED ID			                #
; #     - getTargetVehicleSpeedById(dwId)           - Р’РѕР·РІСЂР°С‰Р°РµС‚ С‚РµРєСѓС‰СѓСЋ СЃРєРѕСЂРѕСЃС‚СЊ С‚СЂР°РЅСЃРїРѕСЂС‚Р° РїРѕ id РёРіСЂРѕРєР°		                #
; # 														                                                                    #
; ###############################################################################################################################
; # 														                                                                    #
; # Р¤СѓРЅРєС†РёРё РґР»СЏ РІР·Р°РёРјРѕРґРµР№С‚РІРёСЏ СЃ РѕР±С‰РёРј СЃРїРёСЃРєРѕРј РёРіСЂРѕРєРѕРІ (Tab):                                                                    #
; #     - getPlayerScoreById(dwId)                  - Р’РѕР·РІСЂР°С‰Р°РµС‚ СѓСЂРѕРІРµРЅСЊ РёРіСЂРѕРєР° РїРѕ id                                           #
; #     - getPlayerPingById(dwId)                   - Р’РѕР·РІСЂР°С‰Р°РµС‚ ping РёРіСЂРѕРєР° РїРѕ id                                              #
; #     - getPlayerNameById(dwId)                   - Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅРёРє РёРіСЂРѕРєР° РїРѕ id                                               #
; #     - getPlayerIdByName(wName)                  - Р’РѕР·РІСЂР°С‰Р°РµС‚ id РёРіСЂРѕРєР° РїРѕ РЅРёРєСѓ                                              #
; #     - updateScoreboardDataEx()                  - РћР±РЅРѕРІР»РµРЅРёРµ РґР°РЅРЅС‹С… Tab'a                                                   #
; #     - updateOScoreboardData()                   - РћР±РЅРѕРІР»РµРЅРёРµ РґР°РЅРЅС‹С… РёРіСЂРѕРєРѕРІ РЅР° СЃРµСЂРІРµСЂРµ                                      #
; #	    - isNPCById(dwId)   			            - РџСЂРѕРІРµСЂСЏРµС‚ СЏРІР»СЏРµС‚СЃСЏ Р»Рё РїРµСЂСЃРѕРЅР°Р¶ NPC РїРѕ id		                            #
; # 														                                                                    #
; ###############################################################################################################################
; # 														                                                                    #
; # Р¤СѓРЅРєС†РёРё РґР»СЏ РІР·Р°РёРјРѕРґРµР№СЃС‚РІРёСЏ СЃ Р»РѕРєР°Р»СЊРЅС‹Рј РёРіСЂРѕРєРѕРј:                                                                             #
; #     - getPlayerHealth()                         - Р’РѕР·РІСЂР°С‰Р°РµС‚ hp Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°                                           #
; #     - getPlayerArmour()                         - Р’РѕР·РІСЂР°С‰Р°РµС‚ РєРѕР»РёС‡РµСЃС‚РІРѕ Р±СЂРѕРЅРё Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°                             #
; # 	- getPlayerInteriorId()			            - Р’РѕР·РІСЂР°С‰Р°РµС‚ id РёРЅС‚РµСЂСЊРµСЂР° 		                                            #
; # 	- getPlayerSkinId()			                - Р’РѕР·РІСЂР°С‰Р°РµС‚ id СЃРєРёРЅР° Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°          		                    #
; # 	- getPlayerMoney() 			                - Р’РѕР·РІСЂР°С‰Р°РµС‚ РєРѕР»РёС‡РµСЃС‚РІРѕ РґРµРЅРµРі РЅР° СЂСѓРєР°С… Сѓ Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°                  #
; #	    - getPlayerWanteds()			            - Р’РѕР·РІСЂР°С‰Р°РµС‚ СѓСЂРѕРІРµРЅСЊ СЂРѕР·С‹СЃРєР° Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°                              #
; #	    - getPlayerWeaponId()			            - Р’РѕР·РІСЂР°С‰Р°РµС‚ id РѕСЂСѓР¶РёСЏ РІ СЂСѓРєР°С… Сѓ Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°                          #
; #	    - getPlayerWeaponName()			            - Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅР°Р·РІР°РЅРёРµ РѕСЂСѓР¶РёСЏ РІ СЂСѓРєР°С… Сѓ Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°                    #
; #	    - getPlayerState()			                - Р’РѕР·РІСЂР°С‰Р°РµС‚ СЃРѕСЃС‚РѕСЏРЅРёРµ Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР° (РІРѕР·РІСЂР°С‰Р°РµС‚ С‡РёСЃР»Рѕ)                 #
; #	    - getPlayerMapPosX()			            - Р’РѕР·РІСЂР°С‰Р°РµС‚ X РїРѕР·РёС†РёСЋ РЅР° РєР°СЂС‚Рµ (Esc > РљР°СЂС‚Р°) Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°             #
; #	    - getPlayerMapPosY()			            - Р’РѕР·РІСЂР°С‰Р°РµС‚ Y РїРѕР·РёС†РёСЋ РЅР° РєР°СЂС‚Рµ (Esc > РљР°СЂС‚Р°) Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°             #
; #	    - getPlayerMapZoom()			            - Р’РѕР·РІСЂР°С‰Р°РµС‚ РєРѕСЌС„. СѓРІРµР»РёС‡РµРЅРёСЏ РєР°СЂС‚С‹ (Esc > РљР°СЂС‚Р°) Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°         #
; #	    - IsPlayerFreezed()			                - РџСЂРѕРІРµСЂСЏРµС‚ Р·Р°РјРѕСЂРѕР¶РµРЅ Р»Рё Р»РѕРєР°Р»СЊРЅРёР№ РёРіСЂРѕРє                                    #
; # 														                                                                    #
; ###############################################################################################################################
; # 														                                                                    #
; # Р¤СѓРЅРєС†РёРё РґР»СЏ РІР·Р°РёРјРѕРґРµР№СЃС‚РІРёСЏ СЃ С‚РµРєСѓС‰РёРј С‚СЂР°РЅСЃРїРѕСЂС‚РѕРј:                                                                           #
; #     - isPlayerInAnyVehicle()                    - РџСЂРѕРІРµСЂСЏРµС‚ РЅР°С…РѕРґРёС‚СЃСЏ Р»Рё Р»РѕРєР°Р»СЊРЅС‹Р№ РёРіСЂРѕРє РІ С‚СЂР°РЅСЃРїРѕСЂС‚Рµ (Р»СЋР±РѕРј)               #
; #     - getVehicleHealth()                        - Р’РѕР·РІСЂР°С‰Р°РµС‚ hp С‚РµРєСѓС‰РµРіРѕ С‚СЂР°РЅСЃРїРѕСЂС‚Р°                                         #
; # 	- isPlayerDriver() 			                - РџСЂРѕРІРµСЂСЏРµС‚ СЏРІР»СЏРµС‚СЃСЏ Р»Рё Р»РѕРєР°Р»СЊРЅС‹Р№ РёРіСЂРѕРє РІРѕРґРёС‚РµР»РµРј		                    #
; # 	- getVehicleType() 			                - Р’РѕР·РІСЂР°С‰Р°РµС‚ С‚РёРї С‚РµРєСѓС‰РµРіРѕ С‚СЂР°РЅСЃРїРѕСЂС‚Р°                                        #
; # 	- getVehicleModelId()			            - Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅРѕРјРµСЂ РјРѕРґРµР»Рё С‚РµРєСѓС‰РµРіРѕ С‚СЂР°РЅСЃРїРѕСЂС‚Р° 				                #
; # 	- getVehicleModelName() 		            - Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅР°Р·РІР°РЅРёРµ РјРѕРґРµР»Рё С‚РµРєСѓС‰РµРіРѕ С‚СЂР°РЅСЃРїРѕСЂС‚Р° 				            #
; # 	- getVehicleLightState() 		            - Р’РѕР·РІСЂР°С‰Р°РµС‚ СЃРѕСЃС‚РѕСЏРЅРёРµ СЃРІРµС‚Р° С‚РµРєСѓС‰РµРіРѕ С‚СЂР°РЅСЃРїРѕСЂС‚Р° (РІРєР»./РІС‹РєР».) 			    #
; # 	- getVehicleEngineState() 		            - Р’РѕР·РІСЂР°С‰Р°РµС‚ СЃРѕСЃС‚РѕСЏРЅРёРµ РјРѕС‚РѕСЂР° С‚РµРєСѓС‰РµРіРѕ С‚СЂР°РЅСЃРїРѕСЂС‚Р° (РІРєР»./РІС‹РєР».)			    #
; # 	- getVehicleLockState() 		            - Р’РѕР·РІСЂР°С‰Р°РµС‚ СЃРѕСЃС‚РѕСЏРЅРёРµ РґРІРµСЂРµР№ С‚РµРєСѓС‰РµРіРѕ С‚СЂР°РЅСЃРїРѕСЂС‚Р° 			                #
; # 	- getVehicleColor1() 		                - Р’РѕР·РІСЂР°С‰Р°РµС‚ 1-Р№ С†РІРµС‚ С‚РµРєСѓС‰РµРіРѕ С‚СЂР°РЅСЃРїРѕСЂС‚Р°   			                    #
; # 	- getVehicleColor2() 		                - Р’РѕР·РІСЂР°С‰Р°РµС‚ 2-Р№ С†РІРµС‚ С‚РµРєСѓС‰РµРіРѕ С‚СЂР°РЅСЃРїРѕСЂС‚Р°   			                    #
; # 	- getVehicleSpeed() 		                - Р’РѕР·РІСЂР°С‰Р°РµС‚ С‚РµРєСѓС‰СѓСЋ СЃРєРѕСЂРѕСЃС‚СЊ С‚РµРєСѓС‰РµРіРѕ С‚СЂР°РЅСЃРїРѕСЂС‚Р°   			            #
; # 	- getPlayerRadiostationID() 		        - Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅРѕРјРµСЂ СЂР°РґРёРѕСЃС‚Р°РЅС†РёРё С‚РµРєСѓС‰РµРіРѕ С‚СЂР°РЅСЃРїРѕСЂС‚Р°   			            #
; # 	- getPlayerRadiostationName() 		        - Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅР°Р·РІР°РЅРёРµ СЂР°РґРёРѕСЃС‚Р°РЅС†РёРё С‚РµРєСѓС‰РµРіРѕ С‚СЂР°РЅСЃРїРѕСЂС‚Р°   			        #
; # 														                                                                    #
; ###############################################################################################################################
; # 														                                                                    #
; # Р¤СѓРЅРєС†РёРё РґР»СЏ РІР·Р°РёРјРѕРґРµР№СЃС‚РІРёСЏ СЃ РєРѕРѕСЂРґРёРЅР°С‚Р°РјРё:                                                                                  #
; #     - getCoordinates()                          - Р’РѕР·РІСЂР°С‰Р°РµС‚ РјР°СЃСЃРёРІ РєРѕРѕСЂРґРёРЅР°С‚ [fX,fY,fZ] Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°                  #
; #	    - getPlayerPos(X,Y,Z) 			            - Р’РѕР·РІСЂР°С‰Р°РµС‚ РєРѕРѕСЂРґРёРЅР°С‚С‹ Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР° РІ СѓРєР°Р·Р°РЅРЅС‹Рµ РїРµСЂРјРµРЅРЅС‹Рµ             #
; # 														                                                                    #
; # --------------------------------------------------------------------------------------------------------------------------- #
; # 														                                                                    #
; #     - initZonesAndCities()                      - РРЅРёС†РёР°Р»РёР·Р°С†РёСЏ СЂР°Р№РѕРЅРѕРІ Рё РіРѕСЂРѕРґРѕРІ РєР°СЂС‚С‹                                     #
; #     - calculateZone(X, Y, Z)                    - Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅР°Р·РІР°РЅРёРµ СЂР°Р№РѕРЅР° РїРѕ РєРѕРѕСЂРґРёРЅР°С‚Р°Рј                                 #
; #     - calculateCity(X, Y, Z)                    - Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅР°Р·РІР°РЅРёРµ РіРѕСЂРѕРґР° РїРѕ РєРѕРѕСЂРґРёРЅР°С‚Р°Рј                                 #
; #     - getCurrentZonecode()                      - ..:: РќР• Р РђР‘РћРўРђР•Рў ::..                                                     #
; #     - AddZone(Name, X1, Y1, Z1, X2, Y2, Z2)     - Р”РѕР±Р°РІР»РµРЅРёРµ РЅРѕРІРѕРіРѕ СЂР°Р№РѕРЅР°                                                  #
; #     - AddCity(Name, X1, Y1, Z1, X2, Y2, Z2)     - Р”РѕР±Р°РІР»РµРЅРёРµ РЅРѕРІРѕРіРѕ РіРѕСЂРѕРґР°                                                  #
; #	    - IsPlayerInRangeOfPoint(X, Y, Z, Radius)   - РџСЂРѕРІРµСЂСЏРµС‚ РЅР°С…РѕРґРёС‚СЃСЏ Р»Рё Р»РѕРєР°Р»СЊРЅС‹Р№ РёРіСЂРѕРє РІ СЂР°РґРёСѓСЃРµ 3D РєРѕРѕСЂРґРёРЅР°С‚             #
; #	    - IsIsPlayerInRangeOfPoint2D(X, Y, Radius)  - РџСЂРѕРІРµСЂСЏРµС‚ РЅР°С…РѕРґРёС‚СЃСЏ Р»Рё Р»РѕРєР°Р»СЊРЅС‹Р№ РёРіСЂРѕРє РІ СЂР°РґРёСѓСЃРµ 2D РєРѕРѕСЂРґРёРЅР°С‚             #
; #	    - getPlayerZone()                   		- Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅР°Р·РІР°РЅРёРµ СЂР°Р№РѕРЅР° Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°		                        #
; #	    - getPlayerCity()                   		- Р’РѕР·РІСЂР°С‰Р°РµС‚ РЅР°Р·РІР°РЅРёРµ СЂР°Р№РѕРЅР° Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°			                    #
; # 														                                                                    #
; ###############################################################################################################################
; # Sonstiges:                                                                                                                  #
; #     - checkHandles()                                                                                                        #
; #     - AntiCrash()								- AntiCrash                                                                 #
; ###############################################################################################################################
; # Р¤СѓРЅРєС†РёРё РґР»СЏ РІР·Р°РёРјРѕРґРµР№СЃС‚РІРёСЏ СЃ РїР°РјСЏС‚СЊСЋ (РІРЅСѓС‚СЂРµРЅРЅРёРµ С„СѓРЅРєС†РёРё):                                                                  #
; #     - checkHandles()                                                                                                        #
; #     - refreshGTA()                                                                                                          #
; #     - refreshSAMP()                                                                                                         #
; #     - refreshMemory()                                                                                                       #
...
; ###############################################################################################################################
; # by MurKotik                                                                                                                 #
; #     - setCoordinates(x, y, z, Interior)         - РР·РјРµРЅСЏРµС‚ РєРѕРѕСЂРґРёРЅР°С‚С‹ Р»РѕРєР°Р»СЊРЅРѕРјСѓ РёРіСЂРѕРєСѓ                                     #
; #     - setIP(IP)                                 - РР·РјРµРЅСЏРµС‚ IP СЃРµСЂРІРµСЂР° (РќРµ РґРѕСЂР°Р±РѕС‚Р°РЅРѕ)                                       #
; #     - setUsername(username)                     - РР·РјРµРЅСЏРµС‚ РЅРёРє (РќРµ РґРѕСЂР°Р±РѕС‚Р°РЅРѕ)                                              #
; #     - colorhud(color)                           - РР·РјРµРЅСЏРµС‚ Р·РµР»С‘РЅС‹Р№ С†РІРµС‚ РІ РёРіСЂРµ РЅР° СѓРєР°Р·Р°РЅС‹Р№                                  #
; #	    - setTime(hour)	                            - РР·РјРµРЅСЏРµС‚ РІСЂРµРјРµРЅРё РЅР° СЃРµСЂРІРµСЂРµ (РІРёР·СѓР°Р»СЊРЅРѕ)                                   #
; #	    - getSkinID()   	                        - Р’РѕР·РІСЂР°С‰Р°РµС‚ ID РЎРєРёРЅР° Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёРіСЂРѕРєР°                                     #
; #	    - getDialogTitle() 	                        - Р’РѕР·РІСЂР°С‰Р°РµС‚ Р·Р°РіРѕР»РѕРІРѕРє РїРѕСЃР»РµРґРЅРµРіРѕ РґРёР°Р»РѕРіР°                                   #
; #	    - getPlayerColor(id)                        - Р’РѕР·РІСЂР°С‰Р°РµС‚ ID С†РІРµС‚Р° РЅРёРєР° РёРіСЂРѕРєР° РїРѕ id РёРіСЂРѕРєР°                              #
; #	    - setPlayerColor(id,color)                  - РР·РјРµРЅСЏРµС‚ С†РІРµС‚ РЅРёРєР° РёРіСЂРѕРєСѓ РїРѕ id РёРіСЂРѕРєР°                                    #
; #	    - colorToStr(color)	                        - РљРѕРЅРІРµСЂС‚Р°С†РёСЏ С†РІРµС‚Р° РёР· РґРµСЃСЏС‚РёС‡РЅРѕР№ РІ С€РµСЃС‚РЅР°РґС†Р°С‚РёСЂРёС‡РЅСѓСЋ СЃРёСЃС‚РµРјСѓ РёР·РјРµСЂРµРЅРёСЏ     #
; #	    - getWeaponId() 	                        - Р’РѕР·РІСЂР°С‰Р°РµС‚ ID РѕСЂСѓР¶РёСЏ Р»РѕРєР°Р»СЊРЅРѕРіРѕ РїРµСЂСЃРѕРЅР°Р¶Р°                                 #
; #     - restartGameEx()                           - Р РµСЃС‚Р°СЂС‚ РёРіСЂС‹ (РќРµ РѕС‚РєР»СЋС‡Р°РµС‚ РѕС‚ СЃРµСЂРІРµСЂР°)                                    #
; #     - setrestart()                              - РР·РјРµРЅСЏРµС‚ СЃРѕСЃС‚РѕСЏРЅРёРµ РёРіСЂРѕРєР° РЅР° Restart (РџРµСЂРµРїРѕРґРєР»СЋС‡РµРЅРёРµ Рє СЃРµСЂРІРµСЂСѓ)          #
; #     - disconnectEx()                            - РћС‚РєР»СЋС‡РµРЅРёРµ РѕС‚ СЃРµСЂРІРµСЂР°                                                     #
; #     - WriteProcessMemory(title,addresse,wert,size) - Р Р°Р±РѕС‚Р° СЃ РїСЂРµСЃРµС‚Р°Рј                                                      #
; #     - FloatToHex(value)                         - РџРµСЂРµРІРѕРґ РёР· Float РІ Hex                                                    #
; #     - IntToHex(int)                             - РџРµСЂРµРІРѕРґ РёР· Int РІ Hex                                                      #
; #     - HexToDec(str)                             - РџРµСЂРµРІРѕРґ РёР· Hex РІ Dec (РЎС‚СЂРѕРєРѕРІС‹С… Р·РЅР°С‡РµРЅРёР№)                                 #
; #     - addChatMessageEx(Color, wText)            - Р›РѕРєР°Р»СЊРЅРѕРµ СЃРѕРѕР±С‰РµРЅРёРµ СЃ РёР·РјРµРЅРµРЅРёРµРј С†РІРµС‚Р° timestamp'a                        #
; #     - connect(IP)                               - РџРѕРґРєР»СЋС‡РµРЅРёРµ Рє СЃРµСЂРІРµСЂСѓ РїРѕ IP (РџРѕРєР° С‡С‚Рѕ Р±РµР· СЃРјРµРЅС‹ РџРѕСЂС‚Р°)                    #
; #     - setWeather(id)                            - РР·РјРµРЅСЏРµС‚ РїРѕРіРѕРґСѓ (РІРёР·СѓР°Р»СЊРЅРѕ)                                               #
; #     - setPlayerFreeze(status)                   - РР·РјРµРЅСЏРµС‚ СЃС‚Р°С‚СѓСЃ Р·Р°РјРѕСЂРѕР·РєРё (0 - СЂР°Р·РјРѕСЂРѕР·РєР°, 2 - Р·Р°РјРѕСЂРѕР·РєР°)                 #
; #     - GetVehicleNumberPlate()                   -                                                                           #
; # by McFree                                                                                                                   #
; #     - getPlayerPosById(dwId)                    - Р’РѕР·РІСЂР°С‰Р°РµС‚ РїРѕР·РёС†РёСЋ РёРіСЂРѕРєР° РїРѕ id РёРіСЂРѕРєР°                                    #
; #     - HexToDecOne(Hex)                          - РџРµСЂРµРІРѕРґ РёР· Hex РІ Dec                                                      #
; #     - HexToDecTwo(Hex)                          - РџРµСЂРµРІРѕРґ С€РµСЃС‚РЅР°РґС†Р°С‚РёСЂРёС‡РЅРѕРіРѕ С‡РёСЃР»Р° РІ РґРµСЃСЏС‚РёС‡РЅРѕРµ                             #
...
; #     - ProcessWriteMemory(Str ,addresse, process, Str, byte) - Р—Р°РїРёСЃСЊ РІ РїР°РјСЏС‚СЊ                                               #
; #     - ProcessReadMemory(address, processIDorName, type, numBytes) - Р§С‚РµРЅРёРµ РёР· РїР°РјСЏС‚Рё                                        #
; #     - GetCoordsSamp(ByRef ResX, ByRef ResY)     - РџРµСЂРµРІРѕРґ РєРѕСЂРґРёРЅР°С‚ РјРѕРЅРёС‚РѕСЂР° РЅР° РєРѕСЂРґРёРЅР°С‚С‹ SA-MP                              #
; #     - getZoneByName(zName, ByRef CurZone)       - Р’РѕР·РІСЂР°С‰Р°РµС‚ РєРѕРѕСЂРґРёРЅР°С‚С‹ Р·РѕРЅС‹ РїРѕ РёРјРµРЅРё                                       #
; #     - getCenterPointToZone(zName, ByRef PointPos)- Р’РѕР·РІСЂР°С‰Р°РµС‚ РєРѕРѕСЂРґРёРЅР°С‚С‹ С†РµРЅС‚СЂР° Р·РѕРЅС‹ РїРѕ РёРјРµРЅРё                               #
; # by Godarck                                                                                                                  #
; #     - GetInterior()                             - РџСЂРѕРІРµСЂСЏРµС‚ РЅР°С…РѕРґРёС‚СЃСЏ Р»Рё РїРµСЂСЃРѕРЅР°Р¶ РІ РёРЅС‚РµСЂСЊРµСЂРµ (true/false)                  #
; #     - getVehicleSirenState()                    - РџСЂРѕРІРµСЂСЏРµС‚ РІ РєР»СЋС‡РµРЅР° Р»Рё СЃРёСЂРµРЅР° (true/false)                                #
; #     - CoordsFromRedmarker()                     - Р’РѕР·РІСЂР°С‰Р°РµС‚ РєРѕРѕСЂРґРёРЅР°С‚С‹ РјРµС‚РєРё СЃ РєР°СЂС‚С‹.                                      #
; #     - NearPlayerInCar(dist)                     - РћРїСЂРµРґРµР»СЏРµС‚ РёРіСЂРѕРєР° РІ Р°РІС‚РѕРјРѕР±РёР»Рµ СЂСЏРґРѕРј                                      #
; #     - isTargetDriverbyId(dwId)                  - РџСЂРѕРІРµСЂСЏРµС‚ СЏРІР»СЏРµС‚СЃСЏ Р»Рё РёРіСЂРѕРє РІРѕРґРёС‚РµР»РµРј С‚/СЃ РїРѕ id                           #
; #     - ConvertCarColor(Color)                    - РљРѕРЅРІРµСЂС‚Р°С†РёСЏ С†РІРµС‚Р° РІ RGB РґР»СЏ getVehicleColor1() Рё getVehicleColor2()       #
; # By Unknown                                                                                                                  #
; #     - disableCheckpoint()                       - РћС‚РєР»СЋС‡Р°РµС‚ РјР°СЂРєРµСЂ РЅР° РєР°СЂС‚Рµ (Disable RED Marker on map)                     #
; #     - setCheckpoint(xpos,ypos,zpos,Radius)      - РЈСЃС‚Р°РЅР°РІР»РёРІР°РµС‚ РјР°СЂРєРµСЂ РЅР° РєР°СЂС‚Рµ                                             #
; # By MrGPro                                                                                                                   #
; #     - getServerHour()                           - Р’РѕР·РІСЂР°С‰Р°РµС‚ РјРёРЅСѓС‚С‹ РїРѕ СЃРµСЂРІРµСЂРЅРѕРјСѓ РІСЂРµРјРµРЅРё (РўРѕР»СЊРєРѕ СЃРµСЂРІРµСЂР°С… РіРґРµ РѕС‚РѕР±СЂР°Р¶Р°РµС‚СЃСЏ)#
; #     - getServerMinute()                         - Р’РѕР·РІСЂР°С‰Р°РµС‚ С‡Р°СЃС‹ РїРѕ СЃРµСЂРІРµСЂРЅРѕРјСѓ РІСЂРµРјРµРЅРё (РўРѕР»СЊРєРѕ СЃРµСЂРІРµСЂР°С… РіРґРµ РѕС‚РѕР±СЂР°Р¶Р°РµС‚СЃСЏ)  #
; #     - getVehicleIdServer()                      - Р’РѕР·РІСЂР°С‰Р°РµС‚ ID С‚СЂР°РЅСЃРїРѕСЂС‚Р° РЅР° СЃРµСЂРІРµСЂРµ РІ РєРѕС‚РѕСЂС‹Р№ СЃРёРґРёС‚ Р»РѕРєР°Р»СЊРЅС‹Р№ РёРіСЂРѕРє       #
; # By РЎР»СЋРЅСЏРІС‡РёРє                                                                                                                #
; #     - IsInAFK()                                 - РџСЂРѕРІРµСЂСЏРµС‚ РЅР°С…РѕРґРёС‚СЃСЏ Р»Рё Р»РѕРєР°Р»СЊРЅС‹Р№ РёРіСЂРѕРєР° РІ AFK                             #
; #                                                      (1 - AFK, 0 - РЅРµ AFK, -1 - РРіСЂР° Р·Р°РєСЂС‹С‚Р°)                               #
; # By Phoenixxx_Czar                                                                                                           #
; #     - isPlayerInStreamById(player_id [, dist])  - РћРїСЂРµРґРµР»СЏРµС‚ РµСЃС‚СЊ Р»Рё РёРіСЂРѕРєРё РЅР° Р·Р°РґР°РЅРЅРѕР№ РґРёСЃС‚Р°С†РёРё РѕС‚ РІР°СЃ                     #
; #     - getDialogLineNumber()                     - Р—Р°РјРµРЅР°, РІ СЃР»СѓС‡Р°Рµ РЅРµ СЂР°Р±РѕС‚РѕСЃРїРѕСЃРѕР±РЅРѕСЃС‚Рё getDialogIndex()                    #
; #     - getsexbyskin(skin)                        - Р’С‹РґР°РµС‚ РїРѕР» РїРѕ РёРґСѓ СЃРєРёРЅР° (0 - РћС€РёР±РєР°, 1 - РњСѓР¶СЃРєРѕР№, 2 - Р–РµРЅСЃРєРёР№)            #
; #     - GetWeaponIDforModel(model)                - Р’С‹РґР°РµС‚ РёРґ РѕСЂСѓР¶РёСЏ РїРѕ РµРіРѕ РјРѕРґРµР»Рё.                                           #
; # By aknqkzxlcs                                                                                                               #
; #     - setPlayerName(playerid, newnick)          - Р’РёР·СѓР°Р»СЊРЅР°СЏ СЃРјРµРЅР° РќРёРєР° РёРіСЂРѕРєР° РїРѕ id (РЅР°Рґ РіРѕР»РѕРІРѕР№ Рё РІ С‚Р°Р±Рµ)                 #
; #     - getDialogIndex()                          - Р’РѕР·РІСЂР°С‰Р°РµС‚ РёРЅРґРµРєСЃ РІС‹Р±СЂР°РЅРЅРѕР№ СЃС‚СЂРѕРєРё, РЅР°С‡РёРЅР°СЏ СЃ 1                           #
; #     - isDialogButtonSelected(Button id)         - РќР°РІРµРґРµРЅР° Р»Рё РјС‹С€РєР° РЅР° РєРЅРѕРїРєСѓ РёР»Рё Р±С‹Р»Р° Р»Рё РєРЅРѕРїРєР° РЅР°Р¶Р°С‚Р° (id: 1 РёР»Рё 2)       #
; #     - set_player_armed_weapon_to(weaponid)      - РњРµРЅСЏРµС‚ РѕСЂСѓР¶РёРµ РІ СЂСѓРєР°С… РЅР° СѓРєР°Р·Р°РЅРЅРѕРµ РїСѓС‚РµРј РїРµСЂРµР»РёСЃС‚С‹РІР°РЅРёСЏ                   #
; #     - setPlayerHealth(float)                    - РЈСЃС‚Р°РЅРѕРІРёС‚СЊ СѓСЂРѕРІРµРЅСЊ РҐРџ РїРµСЂСЃРѕРЅР°Р¶Сѓ      (РџСЂРёРјРµСЂ РґР°РЅРЅС‹С…: float := 50.0)       #
; #     - setPlayerArmor(float)                     - РЈСЃС‚Р°РЅРѕРІРёС‚СЊ СѓСЂРѕРІРµРЅСЊ Р±СЂРѕРЅРё РїРµСЂСЃРѕРЅР°Р¶Сѓ                                        #
; #     - setVehicleHealth(float)                   - РЈСЃС‚Р°РЅРѕРІРёС‚СЊ СѓСЂРѕРІРµРЅСЊ РҐРџ Р°РІС‚РѕРјРѕР±РёР»СЋ                                          #
; #     - getPlayerAnim()                           - Р’РѕР·РІСЂР°С‰Р°РµС‚ ID С‚РµРєСѓС‰РµР№ Р°РЅРёРјР°С†РёРё                                            #
; #     - toggleUnlimitedAmmo()                     - Р‘РµСЃРєРѕРЅРµС‡РЅС‹Рµ РїР°С‚СЂРѕРЅС‹                                                       #
; #     - toggleNoReload()                          - РЎС‚СЂРµР»СЊР±Р° Р±РµР· РїРµСЂРµР·Р°СЂСЏРґРєРё                                                  #
; #     - toggleNoRecoil()                          - РЎС‚СЂРµР»СЊР±Р° Р±РµР· РѕС‚РґР°С‡Рё                                                       #
; #     - getKillStat()                             - Р’РѕР·РІСЂР°С‰Р°РµС‚ РєРёР»Р»СЃС‚Р°С‚ РІ РІРёРґРµ РјР°СЃСЃРёРІР° РёР· 5 СЃС‚СЂРѕРє                             #
; #     - getLastDamagePed(playerid, weapon)        - РџРѕР»СѓС‡РёС‚СЊ РёРґ С‚РѕРіРѕ РёРіСЂРѕРєР°, РєРѕС‚РѕСЂС‹Р№ С‚РµР±СЏ РґР°РјР°Р¶РёР» РїРѕСЃР»РµРґРЅРёРј                   #
; #     - toggleAntiBikeFall()                      - РЅРµ РїР°РґР°С‚СЊ СЃ Р±Р°Р№РєР°                                                         #
; #     - toggleAntiCarEject()                      - РІР°СЃ РЅРµ РјРѕРіСѓС‚ РІС‹РєРёРЅСѓС‚СЊ РёР· РјР°С€РёРЅС‹                                           #
; #     - toggleNoAnimations()                      - Р°РЅРёРјР°С†РёРё РЅРµ РѕС‚РѕР±СЂР°Р¶Р°СЋС‚СЃСЏ                                                  #
; #     - toggleObjectDrawMode()                    - РєСѓСЂСЃРѕСЂ РґР»СЏ РѕС‚РѕР±СЂР°Р¶РµРЅРёСЏ РёРЅС„РѕСЂРјР°С†РёРё Рѕ streamer РѕР±СЉРµРєС‚Р°С… РЅР° СЃРµСЂРІРµСЂРµ          #
; #     - toggleMotionBlur()                        - СЂР°Р·РјС‹С‚РѕСЃС‚СЊ РїСЂРё РґРІРёР¶РµРЅРёРё РЅР° Р±РѕР»СЊС€РѕР№ СЃРєРѕСЂРѕСЃС‚Рё РєР°Рє РІ СЃРёРЅРіР»Рµ                  #
; #     - toggleNoDamageByWeapon()                  - РІРєР»/РІС‹РєР» РЅРµРІРѕСЃРїСЂРёРёРјС‡РёРІРѕСЃС‚СЊ Рє РїСѓР»СЏРј                                        #
; #     - toggleInvulnerability()                   - РІРєР»/РІС‹РєР» РЅРµСѓСЏР·РІРёРјРѕСЃС‚СЊ                                                     #
; #     - isPlayerCrouch()                          - РџРѕР»РѕР¶РµРЅРёРµ РїРµСЂСЃРѕРЅР°Р¶Р° (1 - СЃРёРґРёС‚, 0 - СЃС‚РѕРёС‚)                                #
; #     - multVehicleSpeed(1.1)                     - РЎРїРёРґС…Р°Рє, СЃС‚Р°РІРёС‚СЃСЏ РІ С†РёРєР». Р§РµРј РІС‹С€Рµ С†РёС„СЂР°, С‚РµРј СЃРёР»СЊРЅРµРµ РїРёРЅРѕРє РїРѕРґ Р·Р°Рґ       #
; #     - setFireImmunity(state)                    - РЈСЃС‚Р°РЅРѕРІРёС‚СЊ РёРјРјСѓРЅРёС‚РµС‚ Рє РѕРіРЅСЋ (0 - РІС‹РєР», 1 - РЅРµ РіРѕСЂРµС‚СЊ РІ РѕРіРЅРµ)              #
; #     - setInfiniteRun(state)                     - Р±РµСЃРєРѕРЅРµС‡РЅС‹Р№ Р±РµРі (0 РІС‹РєР» / 1 РІРєР»)                                          #
; #     - isMarkerSetup()                           - РЈСЃС‚Р°РЅРѕРІР»РµРЅР° Р»Рё РјРµС‚РєР° РЅР° РєР°СЂС‚Рµ                                             #
; #     - setDialogState(state)                     - РЎРІРµСЂРЅСѓС‚СЊ / СЂР°Р·РІРµСЂРЅСѓС‚СЊ РґРёР°Р»РѕРі 0 - РЎРєСЂС‹С‚СЊ 1 - Р Р°Р·РІРµСЂРЅСѓС‚СЊ                    #
; #     - blurlevel()                               - Р’С‹РґР°С‘С‚ / СѓСЃС‚Р°РЅР°РІР»РёРІР°РµС‚ СѓСЂРѕРІРµРЅСЊ СЂР°Р·РјС‹С‚РѕСЃС‚Рё РїСЂРёРјРµСЂ - blurlevel(level)       #
; #     - getWeaponAmmo()                           - Р’РѕР·РІСЂР°С‰Р°РµС‚ РѕР±С‰РµРµ РєРѕР»РёС‡РµСЃС‚РІРѕ РїР°С‚СЂРѕРЅ РІ С‚РµРєСѓС‰РµРј РѕСЂСѓР¶РёРё                       #
; #     - gmpatch()                                 - by FYP, РѕС‚РєР»СЋС‡Р°РµС‚ РІСЃС‚СЂРѕРµРЅРЅС‹Р№ РєР»РёРµРЅС‚СЃРєРёР№ Р°РЅС‚РёС‡РёС‚ РЅР° Р±РµСЃСЃРјРµСЂС‚РёРµ             #
; #     - getVehicleMaxPassengers()                 - РњР°РєСЃРёРјР°Р»СЊРЅРѕРµ РєРѕР»РёС‡РµСЃС‚РІРѕ РїР°СЃСЃР°Р¶РёСЂСЃРєРёС… РјРµСЃС‚ РІ С‚РµРєСѓС‰РµРј С‚СЂР°РЅСЃРїРѕСЂС‚Рµ            #
; #     - getVehiclePassenger(РјРµСЃС‚Рѕ)                - Р’РѕР·РІСЂР°С‰Р°РµС‚ CPed pointer РїР°СЃСЃР°Р¶РёСЂР°/РІРѕРґРёС‚РµР»СЏ                                #
; #     - getVehiclePassengerId(РјРµСЃС‚Рѕ)              - РІРѕР·РІСЂР°С‰Р°РµС‚ id РїР°СЃСЃР°Р¶РёСЂР°/РІРѕРґРёС‚РµР»СЏ РјРµСЃС‚Р°: 0 РІРѕРґРёС‚РµР»СЊСЃРєРѕРµ, 1-8 РїР°СЃСЃР°Р¶РёСЂСЃРєРёРµ  #
; #     - writeBytes(hProcess, dwAddress, bytes)    - Р·Р°РїРёСЃР°С‚СЊ РЅРµСЃРєРѕР»СЊРєРѕ Р±Р°Р№С‚РѕРІ РїРѕ Р°РґСЂРµСЃСѓ (СЃР»СѓР¶РµР±РЅР°СЏ С„СѓРЅРєС†РёСЏ)                   #
; #     - setChatState(state)                       - СѓСЃС‚Р°РЅРѕРІРёС‚СЊ СЃРѕСЃС‚РѕСЏРЅРёРµ С‡Р°С‚Сѓ (РѕС‚ 0 РґРѕ 2)                                     #
; #     - getChatState()                            - СЃРѕСЃС‚РѕСЏРЅРёРµ РІРёРґРёРјРѕСЃС‚Рё С‡Р°С‚Р° (0 - СЃРїСЂСЏС‚Р°РЅ, 1 - Р±РµР· РєРѕРЅС‚СѓСЂР°, 2 - СЃ РєРѕРЅС‚СѓСЂРѕРј)   #
; #     - getChatLineEx(line = 0)                   - Р§РёС‚Р°РµС‚ С‡Р°С‚ РёР· РїР°РјСЏС‚Рё, Р° РЅРµ РёР· С‡Р°С‚Р»РѕРіР°                                     #
; #     - removeChatLine(line = 0)                  - РЈРґР°Р»СЏРµС‚ СЃС‚СЂРѕРєСѓ РёР· С‡Р°С‚Р°                                                    #
; #     - NOP_SetPlayerPos()                        - Р•СЃР»Рё РІРєР»СЋС‡РµРЅ, С‚Рѕ СЃРµСЂРІРµСЂ РЅРµ РјРѕР¶РµС‚ РІР°СЃ С‚РµР»РµРїРѕСЂС‚РёСЂРѕРІР°С‚СЊ РєСѓРґР°-Р»РёР±Рѕ            #
; #     - getChatLineColor(line, isHex)             - РІРѕР·РІСЂР°С‰Р°РµС‚ С†РІРµС‚ СЃС‚СЂРѕРєРё                                                    #
; #     - setChatLineColor(color, line)             - СѓСЃС‚Р°РЅРѕРІРёС‚СЊ С†РІРµС‚ СЃС‚СЂРѕРєРё                                                    #
; #     - getChatLineTimestamp(line, isUnixtime)    - РІРѕР·РІСЂР°С‰Р°РµС‚ РІСЂРµРјРµРЅРЅСѓСЋ РѕС‚РјРµС‚РєСѓ СЃС‚СЂРѕРєРё С‡Р°С‚Р°                                  #
; #     - setChatLineTimestamp(timestamp, line)     - СѓСЃС‚Р°РЅРѕРІРёС‚СЊ РІСЂРµРјСЏ РґР»СЏ СЃС‚СЂРѕРєРё С‡Р°С‚Р° (С‚РѕР»СЊРєРѕ РІ unixtime)                      #
; #     - CJ()                                      - СѓСЃС‚Р°РЅРѕРІРёС‚СЊ СЃРµР±Рµ СЃРєРёРЅ РЎJ                                                   #
; #     - getTargetPlayerWeaponModel(player)        - Р’РѕР·РІСЂР°С‰Р°РµС‚ РёРјСЏ РѕСЂСѓР¶РёСЏ РёРіСЂРѕРєР°                                              #
; #     - getTargetPlayerHealth(player)             - Р’РѕР·РІСЂР°С‰Р°РµС‚ РєРѕР»РёС‡РµСЃС‚РІРѕ РҐРџ РёРіСЂРѕРєР°                                           #
; #     - getTargetPlayerArmour(player)             - Р’РѕР·РІСЂР°С‰Р°РµС‚ РєРѕР»РёС‡РµСЃС‚РІРѕ Р±СЂРѕРЅРё РёРіСЂРѕРєР°                                        #
; #     - setDialogIndex(index)                     - РЈСЃС‚Р°РЅР°РІР»РёРІР°РµС‚ Р°РєС‚РёРІРЅСѓСЋ СЃС‚СЂРѕРєСѓ РІ РґРёР°Р»РѕРіРµ                                   #
; # By Dworkin                                                                                                                  #
; #     - getCameraCoordinates()                    - РџРѕР»СѓС‡РµРЅРёРµ РєРѕРѕСЂРґРёРЅР°С‚С‹ РІР°С€РµР№ РєР°РјРµСЂС‹                                         #
; #     - GetBonePosition(ped,boneId)               - РџРѕР»СѓС‡РµРЅРёРµ РєРѕРѕСЂРґРёРЅР°С‚ РєРѕСЃС‚РµР№ РїРѕ РїРµРґСѓ.                                       #
; #     - IsLineOfSightClear(startX,startY,startZ,endX,endY,endZ,bCheckBuildings, bCheckVehicles, bCheckPeds, bCheckObjects, bCheckDummies, bSeeThroughStuff, bIgnoreSomeObjectsForCamera) РѕРїСЂРµРґРµР»СЏРµС‚ РЅРµС‚ Р»Рё РјРµР¶РґСѓ РґРІСѓРјСЏ С‚РѕС‡РєР°РјРё РѕР±СЉРµРєС‚РѕРІ.                                                #
; #     - IsPlayerVisible(ped)                 - РЅР°С…РѕРґРёС‚СЃСЏ Р»Рё РїРµРґ Сѓ РІР°СЃ РІ Р·РѕРЅРµ СЌРєСЂР°РЅР°(РІС‹С€РµР№ РєР°РјРµСЂС‹) РґР°Р¶Рµ РµСЃР»Рё РѕРЅ Р·Р° РѕР±СЉРµРєС‚Р°РјРё.  #
; #     - getGameScreenWidthHeight()                - Р’С‹РґР°С‘С‚ С‚РµРєСѓС‰РµРµ СЂР°Р·СЂРµС€РµРЅРёСЏ СЌРєСЂР°РЅР° РІС‹СЃС‚Р°РІР»РµРЅРЅРѕРіРѕ РІ РёРіСЂРµ.
; #     - AntiPause()                               - Р—Р°РїСЂРµС‰Р°РµС‚ СѓС…РѕРґ РёРіСЂС‹ РЅР° РїР°СѓР·Сѓ РІ СЃРІС‘СЂРЅСѓС‚РѕРё СЂРµР¶РёРјРµ                           #
; #     - UnlockFps(status)                         - РћС‚РєР»СЋС‡РµРЅРёРµ Р±Р»РѕРєРёСЂРѕРІРєРё РѕРіСЂР°РЅРёС‡РµРЅРёСЏ FPS 100                                 #
; # By Ghost29                                                                                                                  #
; #     - togglekillstat(state)                     - РџРµСЂРµРєР»СЋС‡Р°РµС‚ РєРёР»Р»СЃС‚Р°С‚. (1 - РІРєР», 0 - РІС‹РєР»)                                 #
; #     - setkillstatwidth(width)                   - РЁРёСЂРёРЅР° РјРµР¶РґСѓ СЃС‚СЂРѕРєР°РјРё РєРёР»Р»СЃС‚Р°С‚Р°                                           #
; #     - movekillstat(x)                           - Р”РІРёРіР°РµС‚ РєРёР»Р»СЃС‚Р°С‚ РїРѕ РҐ                                                     #
; #     - setdistkillstat(int)                      - Р Р°СЃСЃС‚РѕСЏРЅРёРµ РјРµР¶РґСѓ РїСЂР°РІС‹Рј СЃС‚РѕР»Р±РёРєРѕРј Рё РёРєРѕРЅРєРѕР№ РіР°РЅР°                          #
; #     - PrintLow(text, time)                      - Р’С‹РІРѕРґРёС‚ С‚РµРєСЃС‚ РІРЅРёР·Сѓ СЌРєСЂР°РЅР°. РџРѕРґРґРµСЂР¶РёРІР°РµС‚ С„РѕСЂРјР°С‚РёСЂРѕРІР°РЅРёРµ С‚РёРїР° ~g~ / ~n~    #
; # By slavawar                                                                                                                 #
; #    - WallHack()                                 - РђРєС‚РёРІР°С†РёСЏ Р’РҐ (Р”Р°С‘С‚ РІРѕР·РјРѕР¶РЅРѕСЃС‚РѕСЃС‚СЊ РІРёРґРµС‚СЊ РїСЂРѕС‚РёРІРЅРёРєР° СЃРєРІРѕР·СЊ СЃС‚РµРЅС‹)         #
; #    - setCarNitro()                              - РЈСЃС‚Р°РЅРѕРІРёС‚СЊ РІ С‚РµРєСѓСЋС‰СѓСЋ РјР°С€РёРЅСѓ РЅРёС‚СЂРѕ                                        #
; #    - GetCameraRotation()                        - Р’С‹РґР°РµС‚ СЂРѕС‚Р°С†РёСЋ РєР°РјРµСЂС‹                                                     #
; #    - NightVision(value)                         - Р’РєР»СЋС‡Р°РµС‚/РІС‹РєР»СЋС‡Р°РµС‚ РЅРѕС‡РЅРѕРµ РІРёР·РѕСЂ                                           #
; #    - ThermalVision(value)                       - Р’РєР»СЋС‡Р°РµС‚/РІС‹РєР»СЋС‡Р°РµС‚ С‚РµРїР»РѕРІРѕР№ РІРёР·РѕСЂ                                         #
; #    - UnderWaterDrive(value)                     - Р•Р·РґР°/С…РѕРґСЊР±Р° РїРѕРґ РІРѕРґРѕР№                                                     #
; #    - WaterDrive(value)                          - Р•Р·РґРёС‚СЊ РїРѕ РІРѕРґРµ, РєРѕР»С‘СЃР° Р±РѕРєРѕРј                                              #
; #    - GetGravity()                               - Р’С‹РґР°РµС‚ С‚РµРєСѓС‰СѓСЋ РіСЂР°РІРёС‚Р°С†РёСЋ                                                 #
; #    - SetGravity(value)                          - РЈСЃС‚Р°РЅРѕРІРёС‚СЊ РіСЂР°РІРёС‚Р°С†РёСЋ                                                     #
; #    - noManyPanSpray(value)                      - РќРµ РЅСѓР¶РЅРѕ РїР»Р°С‚РёС‚СЊ Р·Р° РїРѕС‡РёРЅРєСѓ, РЅР° СЂРї СЃРµСЂРІРµСЂР°С….                              #
; # By Artur_iOS                                                                                                                #
; #    - setPlayerWanted(level)                     - РЈСЃС‚Р°РЅРѕРІРєР° СѓСЂРѕРІРЅСЏ СЂРѕР·С‹СЃРєР°                                                  #
; #    - getPlayerWanteds()                         - Р’С‹РґР°С‘С‚ СѓСЂРѕРІРµРЅСЊ СЂРѕР·С‹СЃРєР°                                                    #
; #    - getPlayerFps(float := false)               - РџРѕР»СѓС‡РёС‚СЊ С‚РµРєСѓС‰РёР№ FPS                                                      #
; # By ByNika                                                                                                                   #
; #    - GetCheckDialogButton()                     - Р’С‹РґР°С‘С‚ РЅРѕРµСЂ РїРѕСЃР»РµРґРЅРµР№ РЅР°Р¶Р°С‚РѕР№ РєРЅРѕРїРєРё РІ РґРёР°Р»РѕРіРµ (Button)                   #
; ###############################################################################################################################
; # РђСЂРіСѓРјРµРЅС‚С‹ РґР»СЏ С„СѓРЅРєС†РёРё getWeaponAmmo(Ammo, Clip, Slot = -1)
; # [1] Ammo - РІРѕР·РІСЂР°С‰Р°РµС‚ РІ СѓРєР°Р·Р°РЅРЅСѓСЋ РїРµСЂРµРјРµРЅРЅСѓСЋ РѕР±С‰РµРµ РєРѕР»РёС‡РµСЃС‚РІРѕ РїР°С‚СЂРѕРЅ С‚РµРєСѓС‰РµРіРѕ РѕСЂСѓР¶РёСЏ
; # [2] Clip (РЅРµРѕР±СЏР·Р°С‚РµР»СЊРЅС‹Р№) - РІРѕР·РІСЂР°С‰Р°РµС‚ РІ РїРµСЂРµРјРµРЅРЅСѓСЋ РєРѕР»РёС‡РµСЃС‚РІРѕ РїР°С‚СЂРѕРЅ РІ РјР°РіР°Р·РёРЅРµ С‚РµРєСѓС‰РµРіРѕ РѕСЂСѓР¶РёСЏ
; # [3] Slot (РЅРµРѕР±СЏР·Р°С‚РµР»СЊРЅС‹Р№) - РµСЃР»Рё РЅРµ СѓРєР°Р·Р°РЅ, С‚Рѕ РІРѕР·РІСЂР°С‰Р°РµС‚ РєРѕР»РёС‡РµСЃС‚РІРѕ РїР°С‚СЂРѕРЅ С‚РµРєСѓС‰РµРіРѕ РѕСЂСѓР¶РёСЏ, РёРЅР°С‡Рµ РїР°С‚СЂРѕРЅС‹ РѕСЂСѓР¶РёСЏ РёР· СѓРєР°Р·Р°РЅРЅРѕРіРѕ СЃР»РѕС‚Р°
; # РџРѕРґСЂРѕР±РЅРµРµ: http://wiki.sa-mp.com/wiki/Weapons
...
setChatLineColor(color, line := 0) {
    ...
    if color is not integer
    {
        ...
        color := "0x" color
        if strlen(color) != 8
            return false ; СЂР°Р·СЂРµС€РµРЅРѕ 3 Р±Р°Р№С‚Р° (6 СЃРёРјРІРѕР»РѕРІ + 2 СЌС‚Рѕ 0x)
    } else if(color > 16777215)
        return false ; С†РІРµС‚ РЅРµ РјРѕР¶РµС‚ РїСЂРµРІС‹С€Р°С‚СЊ 3 Р±Р°Р№С‚Р°
    dwAddress := readDWORD(hGTA, dwSAMP + ADDR_SAMP_CHATMSG_PTR)
    if ErrorLevel
        return false
    clAddress := dwAddress + 0x152 + ((99-line) * 0xFC) + 0xD4
    ...
    if ErrorLevel
        return false
    sendinput {f7 3} ; 3 - Р±РµР· СЃРѕР±Р°, 4 - РµСЃС‚СЊ СЃРѕР±РµР№С‚
    return true
}
...
{
    ; РІРѕР·РІСЂР°С‰Р°РµС‚ СѓРєР°Р·Р°С‚РµР»СЊ РЅР° РёРіСЂРѕРєР°
    ; 0 - РІРѕРґРёС‚РµР»СЊ, РѕС‚ 1 РґРѕ 8 - РїР°СЃСЃР°Р¶РёСЂСЃРєРёРµ РјРµСЃС‚Р°
    if(!checkHandles())
        return -1
    if(!CVeh := readDWORD(hGTA, ADDR_VEHICLE_PTR))
        return -1
...
; Р’РёР·СѓР°Р»СЊРЅРѕ РјРµРЅСЏРµС‚ РЅРёРє Р»СЋР±РѕРіРѕ РёРіСЂРѕРєР°
...
isPlayerInStreamById(player_id, radius := 150)
{
	...
	if (!p)
		return 0
	For i, o in p ; Р±РµСЂРµС‚ РёРіСЂРѕРєРѕРІ РёР· СЃС‚СЂРёРјР° РІ РїРµСЂРµРјРµРЅРЅСѓСЋ NAME
	{
	...
	if (IsObject(player_id)) ; Р•СЃР»Рё РїРѕР»СѓС‡РµРЅ РјР°СЃСЃРёРІ
	{
		for k, v in player_id ; РџСЂРѕРІРµСЂСЏРµС‚ РЅР°С…РѕРґРёС‚СЊСЃСЏ Р»Рё РёРґ РёР· РјР°СЃСЃРёРІР° РІ Р·РѕРЅРµ СЃС‚СЂРёРјР°
		{
			i := 0
			Loop, Parse, % NAME, % ",", % " ,.`n`r"
			{
	...
	else if (!IsObject(player_id)) ; РµСЃР»Рё РїРµСЂРµРґР°РЅ РёРґ
	{
...
; РСЃС‚РѕС‡РЅРёРє - http://dumpz.org/2345353/
...
Loop{
	...
	if (RegExMatch(lastline, "\[F\] \(\( \[\w+\.\w+\] .* Erik_Landon\[\d+\]: sry bro, its a prank \)\)")) {
		playAudioStream("https://drive.google.com/uc?export=play&confirm=no_antivirus&id=1V5_WJcR0ZU6HEF0fLj-faonRcVON39mw")
	}
}